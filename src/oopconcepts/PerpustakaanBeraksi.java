...
public class PerpustakaanBeraksi {
    ...
    public static void main(String[] args) {
     ...
     //Output
        ...
        //mutator
        //System.out.println(pinjaman1.jk.Replace("1", "Laki-laki"));
        ...
        System.out.println("Pinalti "+pinjaman1.getPinalti());
        System.out.println("Total Denda "+pinjaman1.getDenda());
